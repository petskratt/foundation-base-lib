...
function krt_versioned_uri($s) {
	...
	// can be used if config is generated by deployment solution, for example in deployHQ:
	// define('DEPLOYMENT_COUNT', %count%);
	if (defined('DEPLOYMENT_COUNT'))
	  $version .= '.' . DEPLOYMENT_COUNT;

	return str_replace( get_bloginfo( 'version' ), $theme->get( 'Version' ) , $s );
}
